...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'd3f42a0b8c8844beb0c97273c1280552',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '3R1C', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只键盘虾', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ikun.website', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '人生不相见，动如参与商, 不知江月待何人, Hi，我是一个干饭人,欢迎来到我的博客🎉',
